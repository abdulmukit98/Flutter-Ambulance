...
class CommonMethods
{
  ...
  // {
  //   String humanReadableAddress = "";
  //   String apiGeoCodingUrl = "https://geocode.maps.co/reverse?lat=${position.latitude}&lon=${position.longitude}&api_key=663f7a5f397e7326458126uzq6c8e0f";
  //
  //   var responseFromAPI = await sendRequestToAPI(apiGeoCodingUrl);
  //   if(responseFromAPI != "error")
  //   {
  ...
  calculateFareAmount(DirectionDetails directionDetails)
  {
    ...
    double durationPerMinuteAmount = 5;
