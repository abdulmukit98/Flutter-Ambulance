...
class _SearchDestinationPageState extends State<SearchDestinationPage>
{
  ...
  //   {
  //     String apiPlacesUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$locationName&key=$placesAPI&components=country:bd";
  //
  ...
  searchLocation(String locationName) async
  {
    if(locationName.length > 1)
    {
      ...
      var responseFromPlaceAPI = await CommonMethods.sendRequestToAPI(apiPlacesUrl);
      print("response: " + responseFromPlaceAPI.toString());
      if(responseFromPlaceAPI  == "error")
      {
        print("predictionResultInJson: error");
        return;
      }
